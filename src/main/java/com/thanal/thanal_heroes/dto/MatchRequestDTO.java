...
public class MatchRequestDTO {
    ...
    public MatchRequestDTO(String tournamentId, String team1Id, String team2Id, LocalDateTime matchDate) {
    ...
    public static class Builder {
        ...
        public MatchRequestDTO build() {
            return new MatchRequestDTO(tournamentId, team1Id, team2Id, matchDate);
        }
    }
